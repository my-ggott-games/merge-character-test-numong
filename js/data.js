...
const qnaList = [
  {
    q: '1. 1 더하기 1은?',
    a: [
      { answer: 'a. 2', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: 'b. 창문', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
      { answer: 'c. 귀요미', type: ['sheep', 'pig' ] },
    ]
  },
  {
...
const infoList = [
  ...
  {
    name: '"우리는 살고 싶은 곳에서 살아. 그래. 자유라는 거야!" <바둑이>',
  ...
  {
    name: '"너는 운이 좋았어. 거의 잡힐 뻔했다구. 내가 다 봤어." <청설모>',
